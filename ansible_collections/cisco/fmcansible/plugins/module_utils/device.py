...
class FmcModel(Enum):
    FMC_ASA5506_X = 'Cisco ASA5506-X Threat Defense'
    FMC_ASA5508_X = 'Cisco ASA5508-X Threat Defense'
    FMC_ASA5516_X = 'Cisco ASA5516-X Threat Defense'

    FMC_2110 = 'Cisco Firepower 2110 Threat Defense'
    FMC_2120 = 'Cisco Firepower 2120 Threat Defense'
    FMC_2130 = 'Cisco Firepower 2130 Threat Defense'
    FMC_2140 = 'Cisco Firepower 2140 Threat Defense'
...
class Fmc2100Platform(AbstractFmcPlatform):
    PLATFORM_MODELS = [FmcModel.FMC_2110, FmcModel.FMC_2120, FmcModel.FMC_2130, FmcModel.FMC_2140]
...
class FmcAsa5500xPlatform(AbstractFmcPlatform):
    PLATFORM_MODELS = [FmcModel.FMC_ASA5506_X, FmcModel.FMC_ASA5508_X, FmcModel.FMC_ASA5516_X]
