...
from ansible_collections.cisco.fmcansible.tests.unit.compat import mock
from ansible_collections.cisco.fmcansible.tests.unit.compat import unittest
from ansible_collections.cisco.fmcansible.tests.unit.compat.mock import mock_open, patch
