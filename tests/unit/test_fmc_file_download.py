...
class TestFmcFileDownload(object):
    module = fmc_file_download
    ...
    def connection_mock(self, mocker):
        connection_class_mock = mocker.patch('ansible_collections.cisco.fmcansible.plugins.modules.fmc_file_download.Connection')
