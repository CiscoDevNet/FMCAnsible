...
try:
    from ansible.module_utils.common import HTTPMethod, equal_objects, FmcConfigurationError, \
        FtdServerError, ResponseParams, copy_identity_properties, FmcUnexpectedResponse
    from ansible.module_utils.fmc_swagger_client import OperationField, ValidationError
except ImportError:
    from module_utils.common import HTTPMethod, equal_objects, FmcConfigurationError, \
