...
options:
  ...
  device_model:
    description:
      - Platform model of the device (e.g., 'Cisco Firewall Management Center 1600').
      - If not specified and connection is 'httpapi`, the module tries to fetch the device model via REST API.
      - For 'local' connection type, this parameter is mandatory.
    required: false
    type: str
    choices:
      - "Cisco Firewall Management Center 1600"
      - "Cisco Firewall Management Center 2600"
      - "Cisco Firewall Management Center 4600"
